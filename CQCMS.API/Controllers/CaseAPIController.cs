...
namespace CQCMS.API.Controllers
{
    public class CaseAPIController : Controller
    {
        ...
        public dynamic SaveCaseDetails(CaseAndEmailUpdateDTO caseUpdateDTO)
        {
            ...
            caseUpdateDTO.UpdateCase.EmployeeName = (caseUpdateDTO.UpdateCase.CurrentlyAssignedTo == null ? null : new UserData().GetUserInfoByEmployeeID(caseUpdateDTO.UpdateCase.Country, caseUpdateDTO.UpdateCase.CurrentlyAssignedTo)?.Employeellame);
