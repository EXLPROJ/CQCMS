...

                        {
...

                            {
                                ...
                                if (matchingAttachment != null)
                                    ...
                                    matchingAttachment = matchingAttachment.ToLower().Contains("attachments") ? matchingAttachment.Split(new string[] { "Attachments" },

                            StringSplitOptions.RemoveEmptyEntries)[1].TrimStart(new char[] { '/', '\\' }) : matchingAttachment;
